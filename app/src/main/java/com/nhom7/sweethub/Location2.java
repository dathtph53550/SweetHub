...
import com.nhom7.sweethub.Adapter.Adapter_Item_District_Select_GHN;
import com.nhom7.sweethub.Adapter.Adapter_Item_Province_Select_GHN;
import com.nhom7.sweethub.Adapter.Adapter_Item_Ward_Select_GHN;
...
import com.nhom7.sweethub.Models.GHNItem;
...
import com.nhom7.sweethub.databinding.ActivityLocation2Binding;
import com.nhom7.sweethub.servers.GHNRequest;
import com.nhom7.sweethub.servers.GHNServices;
        ...
        public void onResponse(Call<ResponseGHN<GHNOrderRespone>> call, Response<ResponseGHN<GHNOrderRespone>> response) {
            if (response.isSuccessful()){
                ...
                if (response.body().getCode() == 200){
                    ...
                    httpRequest.callAPI().order(order).enqueue(new Callback<com.nhom7.sweethub.Model.Response<ArrayList<Category>>>() {
                        @Override
                        public void onResponse(Call<com.nhom7.sweethub.Model.Response<ArrayList<Category>>> call, Response<com.nhom7.sweethub.Model.Response<ArrayList<Category>>> response) {
                            if (response.isSuccessful()){
                        ...
                        @Override
                        public void onFailure(Call<com.nhom7.sweethub.Model.Response<ArrayList<Category>>> call, Throwable t) {
